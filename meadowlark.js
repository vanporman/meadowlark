...
var VacationSeasonListener = require('./models/vacationSeasonListener.js');
...
//handlers for nursery rhyme call
...
app.get('/newsletter', function(req, res){
	// we will learn about CSRF later...for now, we just provide a dummy value - , { csrf: 'CSRF token goes here' });
